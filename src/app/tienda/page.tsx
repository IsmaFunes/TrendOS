  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-6 py-8">
      <header className="mb-10 flex items-center justify-between">
        <Link href="/trends" className="font-display text-xl text-accent">
          TrendOS
        </Link>
      ...
      <p className="mt-2 text-muted">
        Editá tu nicho. Al guardar, reinvestigamos productos alineados a
        keywords + descripción + categorías.
      </p>
